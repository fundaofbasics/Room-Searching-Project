...
<input type=hidden name="i1" value="<%=id1 %>">
<input type=hidden name="i2" value="<%=id1 %>">
<input type=hidden name="i3" value="<%=id1 %>">
<input type=hidden name="i4" value="<%=id1 %>">
<input type=hidden name="i5" value="<%=id1 %>">
<input type=hidden name="i6" value="<%=Place %>">

<input type=submit value="Delete this Record">
</form>
<form action="Insert.jsp">
<input type="submit" value="Insert new Record"> </center></td> </tr>
</form>
</table>
